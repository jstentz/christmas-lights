...
const ErrorMessage = (props: any) => {
    return (
      <div className="z-10 fixed left-1/2 transform -translate-x-1/2 shadow-lg bg-red-400 rounded-lg p-4 max-w-screen-sm" hidden={props.hide}>
        <div className="absolute top-0 right-0">
          <button onClick={props.errorMessageCloseCallback}>
        ...
        <p className="text-slate-800 font-semibold">{props.message}</p>
      </div>
    )
}
