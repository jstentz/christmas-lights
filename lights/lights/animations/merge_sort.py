...
class MergeSort(BaseAnimation):
  def __init__(self, pixels, *, 
    ...
    self.t = 0
    self.colors = [(hue / 255, 1.0, b) for b in np.linspace(brightnessRange[0] / 255, brightnessRange[1] / 255, len(self.pixels))]
  ...
  def reset(self):
    ...
    self.brightnesses = [hsv[2] for hsv in self.colors]
